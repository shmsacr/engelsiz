    ...
    return Padding(
      ...
      child: ListView(
        children: const [
          ...
          _MessageTile(
            message: 'BABABABA Sea Ne yapıyon',
            messageDate: '12:01 PM',
          ),
          _MessageOwnTile(
            message: 'Doktor musun kardeş ne soruyon',
            messageDate: '12:02 PM',
          ),
          _MessageTile(
            message: 'Lan sen ne diyon lan',
            messageDate: '12:02 PM',
          ),
          _MessageOwnTile(
            message: 'Bekle geliyorum seni pis edecem',
            messageDate: '12:03 PM',
          ),
          _MessageTile(
            message: 'Gel lan bekliyorum',
            messageDate: '12:03 PM',
          ),
          _MessageOwnTile(
            message: 'Gel lan!!',
